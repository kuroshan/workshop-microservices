package com.kuroshan.workshop.ms.hr.areas.dao.impl;
  ...
  public Tuple findDepartmentByIdCustom(long id) {
    ...
    TypedQuery<Tuple> query = entityManager.createQuery(
        "SELECT d.departmentId as departmentId, d.departmentName as departmentName, " +
                  ...
                  "FROM Department d, Location l, Country c, Region r " +
                 "WHERE d.departmentId = :id " +
                   "AND d.location.locationId = l.locationId " +
                   "AND l.country.countryId = c.countryId " +
